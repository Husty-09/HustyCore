  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-bold tracking-tight">{dict.components.infiniteMarquee.title}</h1>
        <p className="text-xl text-muted-foreground w-full max-w-2xl">
          {dict.components.infiniteMarquee.description}
        </p>
      </div>

      {/* Preview Section */}
      <div className="flex flex-col gap-4">
        <h3 className="text-xl font-semibold border-b border-border/40 pb-2">{dict.components.infiniteMarquee.previewTitle}</h3>
      ...
      <div className="flex flex-col gap-4 mt-8">
        ...
        <p className="text-sm text-muted-foreground mb-2">{dict.components.infiniteMarquee.usageDesc}</p>
      ...
      <div className="flex flex-col gap-4 mt-8">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          {dict.components.infiniteMarquee.sourceDesc} <code>tailwind.config.ts</code>!
        </p>
