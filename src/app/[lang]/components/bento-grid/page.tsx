  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-xl font-semibold border-b border-border/40 pb-2 text-foreground/80">{dict.components.bentoGrid.previewTitle}</h3>
        ...
        <div className="w-full flex items-center justify-center p-6 md:p-12 border border-border/40 rounded-[2.5rem] bg-grid-pattern relative overflow-hidden bg-background">
          ...
          <BentoGrid className="max-w-4xl w-full mx-auto relative z-10">
            <BentoItem
              title={dict.components.bentoGrid.b1Title}
              description={dict.components.bentoGrid.b1Desc}
              className="md:col-span-2"
              header={
            ...
            />
            <BentoItem
              title={dict.components.bentoGrid.b2Title}
              description={dict.components.bentoGrid.b2Desc}
              className="md:col-span-1"
              header={
            ...
            />
            <BentoItem
              title={dict.components.bentoGrid.b3Title}
              description={dict.components.bentoGrid.b3Desc}
              className="md:col-span-1"
              header={
            ...
            />
            <BentoItem
              title={dict.components.bentoGrid.b4Title}
              description={dict.components.bentoGrid.b4Desc}
              className="md:col-span-2"
              header={
